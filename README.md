...
> Plataforma analítica para identificar transações suspeitas em ambientes bancários, fintechs, marketing financeiro e serviços digitais, combinando **Machine Learning**, **Big Data Analytics**, **análise de redes** e uma interface web em **Streamlit**. <br><br>
